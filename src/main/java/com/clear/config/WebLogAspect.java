...
import com.clear.annotation.SysMonitorLog;
import com.clear.entity.SysLog;
import com.clear.mapper.SysLogMapper;
import com.clear.util.ToolUtil;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.clear.annotation.SysMonitorLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        SysMonitorLog mylog = method.getAnnotation(SysMonitorLog.class);
        if(mylog != null){
            //注解上的描述
