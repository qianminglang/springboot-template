...
public class MybatisPlusGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/template?serverTimezone=Asia/Shanghai";
    ...
    private static InjectionConfig getInjectionConfig() {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/resources/mybatis-mapper/" + tableInfo.getEntityName() + "Mapper"
                        + StringPool.DOT_XML;
            }
        });
